...
class Exporter:
    def __init__(self, config):
        ...
        self.csvs_folder = os.path.join(self.save_path, self.project_name, "csvs")
        self.sonograms_folder = os.path.join(
            self.save_path, self.project_name, "sonograms"
        )
        self.sidescan_folder = os.path.join(
            self.save_path, self.project_name, "georeferenced"
        )
        self.shapefiles_folder = os.path.join(
            self.save_path, self.project_name, "shapefiles"
        )
        self.plots_folder = os.path.join(self.save_path, self.project_name, "plots")
